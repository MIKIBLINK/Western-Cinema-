                                    ...
                                    @if ($rows)
                                        ...
                                        @foreach ($rows as $row)
                                            <tr>
                                                ...
                                                <td class="text-end">
                                                    <a href="{{route('admin.halls.edit',$row->id)}}"><i class="las la-pen text-secondary fs-18"></i></a>
                                                        <form action="{{route('admin.halls.destroy', $row->id)}}" method="POST">
                                                        @csrf
                                                        @method('DELETE')
