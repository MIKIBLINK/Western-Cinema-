                                    ...
                                    @if ($rows)
                                        ...
                                        @foreach ($rows as $row)
                                            <tr>
                                                ...
                                                <td>{{$row ->movie->title ?? 'N/a'}}</td>
                                                <td>{{$row->hall->name}}</td>
                                                <td>{{$row->start_time}}</td>
                                                <td>{{$row->price}}</td>
                                                <td class="text-end">
                                                    <a href="{{route('admin.showtimes.edit',$row->id)}}"><i class="las la-pen text-secondary fs-18"></i></a>
                                                        <form action="{{route('admin.showtimes.destroy', $row->id)}}" method="POST">
                                                        @csrf
                                                        @method('DELETE')
