                    ...
                    <li class="dropdown topbar-item">
                        ...
                        <div class="py-0 dropdown-menu dropdown-menu-end">
                            ...
                            {{-- <a class="dropdown-item text-danger" href="{{ route('logout') }}" onclick="event.preventDefault();
                                        ...
                                        <i class="align-text-bottom las la-power-off fs-18 me-1"></i>
                                        {{ __('Logout') }}
                            </a> --}}
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse " id="sidebarDashboards">
                                <ul class="nav flex-column">
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{route('admin.movies.index')}}">Movie</a>
                                    </li><!--end nav-item-->

                                    <li class="nav-item">
                                        <a class="nav-link" href="{{route('admin.halls.index')}}">Hall</a>
                                    </li><!--end nav-item-->

                                    <li class="nav-item">
                                        <a class="nav-link" href="{{route('admin.showtimes.index')}}">Showtime</a>
                                    </li><!--end nav-item-->

                                    <li class="nav-item">
                                        <a class="nav-link" href="{{route('admin.seats.index')}}">Seat</a>
                                    </li><!--end nav-item-->
                                     <li class="nav-item">
                                        <a class="nav-link" href="{{route('admin.bookings.index')}}">Booking</a>
                                    </li><!--end nav-item-->
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{route('admin.payments.index')}}">Payment</a>
                                    </li><!--end nav-item-->
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{route('admin.users.index')}}">Customer</a>
                                    </li><!--end nav-item-->
