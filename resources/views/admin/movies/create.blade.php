...
@section('content')
    <div class="container-xxl">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('admin.movies.store') }}" method="POST" id="form-validation-2" class="form" enctype="multipart/form-data">
                    @csrf     
                    ...
                    <div class="mb-2">
                        ...
                        <input type="text" class="form-control" name="rating" placeholder="Enter rating" required value="{{old('rating')}}">
                        @error('duration')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
