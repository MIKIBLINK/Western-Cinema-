                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col">
                                <h4 class="card-title">List of Movie</h4>
                            </div><!--end col-->
                            <div class="col-auto">
                                <form class="row g-2">
                                    <div class="col-auto">
                        ...
                        <div class="table-responsive">
                            <table class="table mb-0 checkbox-all" id="datatable_1">
                                <thead class="table-light">
                                    <tr>
                                        <th class="ps-1">No</th>
                                        <th class="ps-1">Poster</th>
                                        <th class="ps-1">title</th>
                                        <th class="ps-1">Description</th>
                                        <th class="ps-1">Duration</th>
                                        <th class="ps-1">Rating</th>
                                    ...
                                    @if ($rows)
                                        ...
                                        @foreach ($rows as $row)
                                            <tr>
                                                <td>{{$i++}}</td>
                                                <td>
                                                    <img src="{{asset($row->poster)}}" class="avatar avatar-md rounded-circle" width="80px">
                                                </td>
                                                <td>{{$row -> title}}</td>
                                                ...
                                                <td>{{$row-> rating}}</td>
                                                <td class="text-end">
                                                    <a href="{{route('admin.movies.edit',$row->id)}}"><i class="las la-pen text-secondary fs-18"></i></a>
                                                        <form action="{{route('admin.movies.destroy', $row->id)}}" method="POST">
                                                        @csrf
                                                        @method('DELETE')
