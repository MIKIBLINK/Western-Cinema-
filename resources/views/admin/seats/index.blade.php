                                ...
                                <tbody>
                                    @if ($rows)
                                        ...
                                        @foreach ($rows as $row)
                                            <tr>
                                                <td>{{$i++}}</td>
                                                <td>{{ $row->hall->name }}</td>   <!-- Get the hall name from the Hall model -->
                                                <td>{{ $row->seat_row }}</td>
                                                <td>{{ $row->seat_number }}</td>
                                                <td class="text-end">
                                                    <a href="{{route('admin.seats.edit',$row->id)}}"><i class="las la-pen text-secondary fs-18"></i></a>
                                                        <form action="{{route('admin.seats.destroy', $row->id)}}" method="POST">
                                                        @csrf
                                                        @method('DELETE')
